...
\abstract
% Escreva seu abstract no arquivo abstract.tex
\input{abstract}

% Sumário (tables of contents)
\tableofcontents
...
% Lista de acrônimos (siglas) (list of acronyms)
% Veja o munal de como usar acroônimos em latex:
